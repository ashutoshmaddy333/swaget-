...
const FAQ = () => {
    ...
    return (
        <>
            {/* SEO Meta Tags */}
            <Helmet>
                <title>FAQs | Swaget Infocomm Solutions LLP - Web Design & Development Services</title>
                <meta 
                    name="description" 
                    content="Find answers to common questions about Swaget's web design, development, and digital marketing services. Learn about pricing, support, and our process." 
                />
                <meta 
                    name="keywords" 
                    content="website design FAQ, web development questions, e-commerce website queries, digital marketing services India" 
                />
                <meta property="og:title" content="FAQs | Swaget Infocomm Solutions LLP" />
                <meta property="og:description" content="Get answers to common questions about our web design and development services." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://swaget.com/faq" />
                <link rel="canonical" href="https://swaget.com/faq" />
            ...
            <section id="faq" className="py-3 bg-gradient-to-b from-gray-900 to-gray-950 text-yellow-400 relative overflow-hidden" itemScope itemType="https://schema.org/FAQPage">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <header className="text-center mb-16">
                        ...
                        <h1 className="text-5xl md:text-6xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500">
                    ...
                    {/* Main FAQ container with schema markup */}
                        ...
                        <div className="relative bg-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-gray-700/50 backdrop-blur-sm">
                            ...
                            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 border-b border-gray-700/50 flex justify-between items-center">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <h2 className="text-2xl font-bold text-yellow-400">Questions & Answers</h2>
                                </div>
                                    ...
                                    {faqData.map((item, index) => (
                                        ...
                                        >
                                            <div className="bg-gradient-to-r from-gray-800/80 via-gray-800/90 to-gray-800/80 relative">
                                                ...
                                                {/* Answer section with schema markup */}
                                                <div 
                                                    id={`faq-answer-${index}`}
                                                ...
                                                >
                                                    <div className="p-6 bg-gradient-to-b from-gray-800/70 to-gray-900/80 text-gray-300 border-t border-gray-700/50 text-lg leading-relaxed" itemProp="text">
                                                        {item.answer}
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="bg-gradient-to-b from-gray-900/70 to-gray-900 p-5 border-t border-gray-700/50 text-center">
                                <div className="text-gray-500 hover:text-yellow-400 transition-colors duration-300 inline-flex items-center">
                                    ...
                                    <a href="/contact" className="font-medium text-yellow-400 hover:underline" aria-label="Contact us for more questions">Contact us</a>
                                </div>
                            </div>
                        </div>
                    </div>
